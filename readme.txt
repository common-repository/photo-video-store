...
Tags: sell photos, sell prints, sell video, ecommerce, photography, stock photography, rights-managed photos, sell digital downloads, paypal, stripe, ffmpeg, subscription
...
* ElasticSearch;
* CSV uploader;
* New payment gateways: CinetPay, Yandex.Money, WePay, BePaid, Klarna, PayPlug, PayU (international).
