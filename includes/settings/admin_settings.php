...
if ( @$pvs_global_settings["packages"] )
{
	$pvs_submenu_admin["catalog_packages"] = pvs_word_lang( "Packages" );
	$pvs_submenu_admin_url["catalog_packages"] = "/packages/index.php";
}
...
if ( @$pvs_global_settings["prints"] )
{
	...
	if ( PVS_LICENSE != 'Free'  and @$pvs_global_settings[ 'ac' . 'ti' .'va' . 'tion' ] ) {
		...
		$pvs_submenu_admin["prints_canvaspop"] = pvs_word_lang( "Canvaspop" );
		$pvs_submenu_admin_url["prints_canvaspop"] = "/prints_canvaspop/index.php";
	}
}
//End. Prints submenu
...
if ( PVS_LICENSE != 'Free'  and @$pvs_global_settings[ 'ac' . 'ti' .'va' . 'tion' ] ) {
	$pvs_submenu_admin["settings_elasticsearch"] = pvs_word_lang( "ElasticSearch" );
	$pvs_submenu_admin_url["settings_elasticsearch"] = "/elasticsearch/index.php";
}
