...
//Update settings
if ( @$_POST["action"] == 'update' and wp_verify_nonce( @$_REQUEST['_wpnonce'], 'pvs-settings' ) )
{
...
$pvs_setting_group['dropzone_uploader'] = 'upload';
...
$pvs_setting_group['no_cart'] = 'orders';
$pvs_setting_group['catalog_url'] = 'catalog';
$pvs_setting_group['adult_content_show'] = 'catalog';
$pvs_setting_group['packages'] = 'orders';
$pvs_setting_group['language_seller'] = 'lang';
...
<input type="hidden" id="group_name" name="group_name" value="<?php echo ( $pvs_group_default ); ?>">
<?php wp_nonce_field( 'pvs-settings' ); ?>
