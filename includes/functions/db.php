	...
	PVS_DB_PREFIX . 'audio_types' )
{
	...
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"audio_types` VALUES(1001, 'MP3', 'mp3', 1, 1, 0, 4583, 1)";
	$wpdb->query( $sql );

	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"audio_types` VALUES(1002, 'WAV', 'wav', 2, 2, 0, 4583, 2)";
	$wpdb->query( $sql );

	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"audio_types` VALUES(1003, 'Shipped CD', 'shipped', 10, 5, 1, 4583, 0)";
	$wpdb->query( $sql );

	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"audio_types` VALUES(1004, 'MP3', 'mp3', 10, 1, 0, 4584, 1)";
	$wpdb->query( $sql );

	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"audio_types` VALUES(1005, 'Shipped CD', 'shipped', 100, 3, 1, 4584, 0)";
	$wpdb->query( $sql );

	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"audio_types` VALUES(1006, 'WAV', 'wav', 20, 2, 0, 4584, 2)";
	$wpdb->query( $sql );

	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"audio_types` VALUES(1007, 'ZIP', 'zip', 3, 3, 0, 4583, 0)";
	$wpdb->query( $sql );
	...
	PVS_DB_PREFIX . 'settings' )
{
	...
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ('Items on the page', '12', 'k_str', 80, 'site', 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
	...
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ('Google Coordinates', '0', 'google_coordinates', 585, 'site', 1)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
	...
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ('Activation', '1', 'activation', 0, 'api',0)";
	$wpdb->query( $sql );
}
	...
	PVS_DB_PREFIX . 'sizes' )
{
	...
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2005, 0, NULL, 125, 4, 'Electronic Items for Resale (unlimited run)', 4584, 0, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2006, 0, NULL, 125, 3, 'Items for Resale (limited run)', 4584, 0, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2007, 0, NULL, 125, 2, 'Unlimited Reproduction / Print Runs', 4584, 0, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2008, 0, NULL, 75, 1, 'Multi-Seat (unlimited)', 4584, 0, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2004, 0, NULL, 4, 4, 'Original size', 4583, 0, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2003, 900, NULL, 3, 3, 'Large', 4583, 0, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2001, 500, NULL, 0, 1, 'Small Free', 4583, 1, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2002, 800, NULL, 2, 2, 'Medium', 4583, 0, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"sizes` VALUES(2009, 0, NULL, 100, 5, 'Extended Legal Guarantee covers up to $250,000', 4584, 0, 1, 0, 0, 0, 0, 0)";
	$wpdb->query( $sql );
	...
	PVS_DB_PREFIX . 'vector_types' )
{
	...
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"vector_types` VALUES(3000, 'ZIP', 'zip', 5, 2, 0, 4583, 1)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"vector_types` VALUES(3001, 'Shipped CD', 'shipped', 10, 5, 1, 4583, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"vector_types` VALUES(3002, 'ZIP', 'zip', 50, 0, 0, 4584, 1)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"vector_types` VALUES(3003, 'Shipped CD', 'shipped', 100, 5, 1, 4584, 0)";
	$wpdb->query( $sql );
	...
	PVS_DB_PREFIX . 'video_types' )
{
	...
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4001, 'QuickTime', 1, 'mov', 5, 0, 4583, 2)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4002, 'AVI', 2, 'avi', 6, 0, 4583, 3)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4003, 'WMV', 3, 'wmv', 3, 0, 4583, 4)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4004, 'FLV', 4, 'flv', 5, 0, 4583, 5)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4005, 'Shipped CD', 5, 'shipped', 10, 1, 4583, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4006, 'AVI', 2, 'avi', 60, 0, 4584, 3)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4007, 'QuickTime', 1, 'mov', 50, 0, 4584, 2)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4008, 'WMV', 3, 'wmv', 30, 0, 4584, 4)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4009, 'FLV', 4, 'flv', 50, 0, 4584, 5)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4010, 'Shipped CD', 5, 'shipped', 100, 1, 4584, 0)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4011, 'MP4', 0, 'mp4', 5, 0, 4583, 1)";
	$wpdb->query( $sql );
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"video_types` VALUES(4012, 'MP4', 0, 'mp4', 40, 0, 4584, 1)";
	$wpdb->query( $sql );
...
if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'media', 'url_jp2' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'media add column (url_jp2 varchar(100))';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'media', 'url_jpf' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'media add column (url_jpf varchar(100))';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'media', 'url_zip' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'media add column (url_zip varchar(100))';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'sizes', 'jp2' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'sizes add column (jp2 tinyint)';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'sizes', 'jpf' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'sizes add column (jpf tinyint)';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'sizes', 'zip' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'sizes add column (zip tinyint)';
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "photos_formats` where photo_type = 'jp2'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX . "photos_formats` (photo_type, title, enabled) VALUES ('jp2', '*.jp2', 0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "photos_formats` where photo_type = 'jpf'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX . "photos_formats` (photo_type, title, enabled) VALUES ('jpf', '*.jpf', 0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "photos_formats` where photo_type = 'zip'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX . "photos_formats` (photo_type, title, enabled) VALUES ('zip', '*.zip', 0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'no_cart'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ('Direct checkout without shopping cart', '0', 'no_cart', 77, 'site',1)";
	$wpdb->query( $sql );
}



$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payme_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'Payme account', '' , 'payme_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payme_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Payme password', '', 'payme_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payme_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Payme active', '0' , 'payme_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payme_test'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Payme test', '0', 'payme_test', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'paytm_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Paytm account', '' , 'paytm_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'paytm_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Paytm password', '', 'paytm_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'paytm_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Paytm active', '0', 'paytm_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'euplataesc_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'EuPlataesc account', '', 'euplataesc_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'euplataesc_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'EuPlataesc password', '', 'euplataesc_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'euplataesc_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'EuPlataesc active', '0' , 'euplataesc_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'catalog_url'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Catalog URL', '' , 'catalog_url', '79','site',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adult_content_show'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Only registered users may see adult content', '0' , 'adult_content_show', '82','site',1)";
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'administrators_stats', 'property_value_old' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'administrators_stats add column (property_value_old int)';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'administrators_stats', 'property_value_count' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'administrators_stats add column (property_value_count int)';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'sizes', 'contacts' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'sizes add column (contacts tinyint)';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'items', 'contacts' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'items add column (contacts tinyint)';
	$wpdb->query( $sql );
}
...
//19.03 Update
$sql = "select id from `" . PVS_DB_PREFIX . "filestorage` where name = 'Backblaze'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX . "filestorage` (`url`,`activ`,`types`,`name`) VALUES (NULL, 0, 3, 'Backblaze')";
	$wpdb->query( $sql );
}
...
if ( $wpdb->get_var( "SHOW TABLES LIKE '" . PVS_DB_PREFIX . "packages'" ) !=
	PVS_DB_PREFIX . 'packages' )
{

	$sql = "CREATE TABLE `" . PVS_DB_PREFIX . "packages` (
	  `id` int(11) NOT NULL auto_increment,
	  `title` varchar(250) default NULL,
	...
	$sql = 'ALTER TABLE `' . PVS_DB_PREFIX .
		'packages` CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;';
	$wpdb->query( $sql );
}


if ( $wpdb->get_var( "SHOW TABLES LIKE '" . PVS_DB_PREFIX . "packages_files'" ) !=
	PVS_DB_PREFIX . 'packages_files' )
{

	$sql = "CREATE TABLE `" . PVS_DB_PREFIX . "packages_files` (
	`id` int(11) NOT NULL auto_increment,
	...
	$sql = 'ALTER TABLE `' . PVS_DB_PREFIX .
		'packages_files` CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;';
	$wpdb->query( $sql );
}



if ( $wpdb->get_var( "SHOW TABLES LIKE '" . PVS_DB_PREFIX . "packages_categories'" ) !=
	PVS_DB_PREFIX . 'packages_categories' )
{

	$sql = "CREATE TABLE `" . PVS_DB_PREFIX . "packages_categories` (
	  `id` int(11) NOT NULL auto_increment,
	  ...
	  KEY `package_id` (`package_id`),
	  KEY `category_id` (`category_id`),
	  KEY `package_category` (`package_id`,`category_id`)
	)";
	$wpdb->query( $sql );

	$sql = 'ALTER TABLE `' . PVS_DB_PREFIX .
		'packages_categories` CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;';
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'packages'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Packages', '0' , 'packages', '81','site',1)";
	$wpdb->query( $sql );
}


if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'carts_content', 'package' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'carts_content add column (package tinyint)';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'orders_content', 'package' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'orders_content add column (package tinyint)';
	$wpdb->query( $sql );
}

if ( $wpdb->get_var( "SHOW TABLES LIKE '" . PVS_DB_PREFIX . "packages_list'" ) !=
	PVS_DB_PREFIX . 'packages_list' )
{

	$sql = "CREATE TABLE `" . PVS_DB_PREFIX . "packages_list` (
	`id` int(11) NOT NULL auto_increment,
	`package_id` int(11) NOT NULL,
	`package_files_id` int(11) NOT NULL,
	`cart_content_id` int(11) NOT NULL,
	...
	KEY `cart_content_id` (`cart_content_id`),
	KEY `order_content_id` (`order_content_id`),
	KEY `file_id` (`file_id`),
	...
	$sql = 'ALTER TABLE `' . PVS_DB_PREFIX .
		'packages_list` CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;';
	$wpdb->query( $sql );
}


if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'downloads', 'package_id' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'downloads add column (package_id int)';
	$wpdb->query( $sql );
}



$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'cinetpay_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'Cinetpay API key', '' , 'cinetpay_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'cinetpay_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Cinetpay Site ID', '', 'cinetpay_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'cinetpay_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Cinetpay active', '0' , 'cinetpay_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'cinetpay_test'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Cinetpay test', '0', 'cinetpay_test', '0','gateways',1)";
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'filestorage_files', 'file_id' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'filestorage_files add column (file_id varchar(200))';
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'yandex2_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'Yandex.Money ID', '' , 'yandex2_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'yandex2_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Yandex.Money password', '', 'yandex2_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'yandex2_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Yandex.Money active', '0' , 'yandex2_active', '0','gateways',1)";
	$wpdb->query( $sql );
}



$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'wipay_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'Wipay developer ID', '' , 'wipay_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'wipay_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Wipay Merchant Key', '', 'wipay_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'wipay_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'wipay active', '0' , 'wipay_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'wipay_test'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'wipay test', '0', 'wipay_test', '0','gateways',1)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'show_users_type'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Show users as', 'name', 'show_users_type', '244','site',0)";
	$wpdb->query( $sql );
}



if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'video_types', 'contacts' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'video_types add column (contacts int)';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'audio_types', 'contacts' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'audio_types add column (contacts int)';
	$wpdb->query( $sql );
}

if ( ! pvs_table_column_exists( PVS_DB_PREFIX . 'vector_types', 'contacts' )) {
	$sql = 'alter table ' . PVS_DB_PREFIX . 'vector_types add column (contacts int)';
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'eu_tax_country'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX . "settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ('Require to confirm a country', '0', 'eu_tax_country', 0, 'eu_tax', 0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'eu_tax_vat_validation'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX . "settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ('Automatic VAT number validation', '0', 'eu_tax_vat_validation', 0, 'eu_tax', 0)";
	$wpdb->query( $sql );
}



$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'bepaid_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'Bepaid Shop ID', '' , 'bepaid_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'bepaid_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Bepaid Security key', '', 'bepaid_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'bepaid_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'bepaid active', '0' , 'bepaid_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'bepaid_test'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'bepaid test', '0' , 'bepaid_test', '0','gateways',1)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch', '' , 'elasticsearch', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch_url'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch URL', 'http://localhost:9200' , 'elasticsearch_url', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch_index'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch Index name', 'pvs' , 'elasticsearch_index', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch_automatic'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch automatic', '0' , 'elasticsearch_automatic', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch_search'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch for search', '1' , 'elasticsearch_search', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch_related'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch for related items', '1' , 'elasticsearch_related', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch_home'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch for home page', '1' , 'elasticsearch_home', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch_cron'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch cron portion', '100' , 'elasticsearch_cron', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'elasticsearch_type'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'ElasticSearch type', 'media' , 'elasticsearch_type', '0','elasticsearch',0)";
	$wpdb->query( $sql );
}


if ( $wpdb->get_var( "SHOW TABLES LIKE '" . PVS_DB_PREFIX . "elasticsearch'" ) !=
	PVS_DB_PREFIX . 'elasticsearch' )
{

	$sql = "CREATE TABLE `" . PVS_DB_PREFIX . "elasticsearch` (
	`id` int(11) NOT NULL auto_increment,
	`publication_id` int(11) NOT NULL,
	`data` int(11) NOT NULL,
	`update_delete` tinyint NOT NULL,
	PRIMARY KEY  (`id`),
	KEY `publication_id` (`publication_id`),
	KEY `data` (`data`),
	KEY `update_delete` (`update_delete`)
	)";
	$wpdb->query( $sql );

	$sql = 'ALTER TABLE `' . PVS_DB_PREFIX .
		'elasticsearch` CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;';
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'klarna_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'klarna Shop ID', '' , 'klarna_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'klarna_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'klarna Security key', '', 'klarna_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'klarna_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'klarna active', '0' , 'klarna_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'klarna_test'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'klarna test', '0' , 'klarna_test', '0','gateways',1)";
	$wpdb->query( $sql );
}



$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payplug_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'Payplug Public Key', '' , 'payplug_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payplug_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Payplug Security key', '', 'payplug_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payplug_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Payplug active', '0' , 'payplug_active', '0','gateways',1)";
	$wpdb->query( $sql );
}
...
$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adobe_api'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Adobe Stock API', '0' , 'adobe_api', '0','stockapi',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adobe_id'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Adobe Stock API key', 'fea420b04f8f4d98baacb9f0dfc44f66' , 'adobe_id', '0','stockapi',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adobe_key'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Adobe Stock API secret', '38fe1b33-3d91-415f-b272-5895aa8aac81' , 'adobe_key', '0','stockapi',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adobe_contributor'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Adobe Stock Contributor', '' , 'adobe_contributor', '0','stockapi',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adobe_pages'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Create internal pages for files', '1' , 'adobe_pages', '0','stockapi',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adobe_prints'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Adobe Stock Prints', '1' , 'adobe_prints', '0','stockapi',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adobe_files'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Adobe Stock files', '1' , 'adobe_files', '0','stockapi',1)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'adobe_show'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Adobe Stock show files/prints by default', '1' , 'adobe_show', '0','stockapi',0)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payu2_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'PayU.ro account', '' , 'payu2_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payu2_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'PayU.ro Security key', '', 'payu2_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payu2_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'PayU.ro active', '0' , 'payu2_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payu2_test'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'PayU.ro test', '0' , 'payu2_test', '0','gateways',1)";
	$wpdb->query( $sql );
}
...
//19.09 Update
$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payway_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'PayWay Shop ID', '' , 'payway_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payway_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'PayWay Security key', '', 'payway_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payway_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'PayWay active', '0' , 'payway_active', '0','gateways',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'payway_test'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'PayWay test', '0' , 'payway_test', '0','gateways',1)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'canvaspop'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'CanvasPop', '0' , 'canvaspop', '0','canvaspop',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'canvaspop_key'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'CanvasPop Key', '' , 'canvaspop_key', '0','canvaspop',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'canvaspop_secret'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'CanvasPop Secret Key', '' , 'canvaspop_secret', '0','canvaspop',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'paypal_direct'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Paypal direct payment', '' , 'paypal_direct', '0','paypal',0)";
	$wpdb->query( $sql );
}
...
$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'advcash_account'";
if ( ! $wpdb->query( $sql ) ) {
	$sql="INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (`name` ,`svalue`,`setting_key` ,`priority`,`stype`	, checkboxes) VALUES ( 'Advcash account', '' , 'advcash_account', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'advcash_password'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Advcash Security key', '', 'advcash_password', '0','gateways',0)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'advcash_active'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Advcash active', '0' , 'advcash_active', '0','gateways',1)";
	$wpdb->query( $sql );
}


$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'dropzone_uploader'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Dropzone photo uploader', '0' , 'dropzone_uploader', '615','site',1)";
	$wpdb->query( $sql );
}

$sql = "select id from `" . PVS_DB_PREFIX . "settings` where setting_key = 'language_seller'";
if ( ! $wpdb->query( $sql ) ) {
	$sql = "INSERT INTO `" . PVS_DB_PREFIX .
		"settings` (name, svalue,setting_key, priority, stype	, checkboxes) values ( 'Sellers may translate titles, descriptions and keywords', '0' , 'language_seller', '660','site',1)";
	$wpdb->query( $sql );
}
?>